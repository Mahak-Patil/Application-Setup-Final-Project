...
<table>
<tr>
<td bgcolor="#FA58F4">Username: </td>
<td><input type="text" name="firstname"></td>
</tr>
 <tr> 
<td bgcolor="#FA58F4">Send this file: </td>
<td><input name="userfile" type="file" accept="image/png,image/jpeg"/></td>
</tr>   
<tr>
<td bgcolor="#FA58F4">Email of user: </td>
<td><input type="email" name="useremail"></td>
</tr>
<tr>
<td bgcolor="#FA58F4">Phone number (1-XXX-XXX-XXXX): </td>
<td><input type="phone" name="phone"></td>
</tr>
<tr>
<td colspan="3"><input type="submit" value="Send File" />
</tr>
</table>
</form>
